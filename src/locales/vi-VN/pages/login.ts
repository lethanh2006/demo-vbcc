export default {
	...
	'pages.exception.loading': 'Đang tải...',
	'pages.exception.backhome': 'Về trang chủ',
	'pages.exception.portal': 'Tới trang Cổng thông tin',
	'pages.exception.logout': 'Đăng xuất',
	'pages.exception.403.title': 'Truy cập bị từ chối',
	'pages.exception.403.subtitle': 'Xin lỗi, bạn không có quyền truy cập trang này.',
	'pages.exception.404.subtitle': 'Xin lỗi, trang bạn yêu cầu không tồn tại.',
	'pages.exception.500.subtitle': 'Xin lỗi, máy chủ trả về lỗi.',
	'pages.exception.updating.title': 'Đang cập nhật',
	'pages.exception.updating.subtitle': 'Hệ thống đang cập nhật. Vui lòng thử lại sau!',
};
