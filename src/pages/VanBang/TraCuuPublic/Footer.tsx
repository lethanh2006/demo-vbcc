		...
		<div className='box-wrapper'>
			<div className='container'>
				<div className='header'>
					<img className='logo' src='/logo.png' alt='VWA Logo' />
				...
				<Row gutter={[12, 0]}>
					<Col span={24} md={16}>
						<div className='contact-info'>
							<div className='contact-item'>
								...
								<a
									className='link'
									href='https://www.google.com/maps?q=68+Nguy%E1%BB%85n+Ch%C3%AD+Thanh,+%C4%90%E1%BB%91ng+%C4%90a,+H%C3%A0+N%E1%BB%99i'
									target='_blank'
							...
							<div className='contact-item'>
								...
								<a className='link' href='tel:02438343504'>
									(024) 38343504
								</a>
							</div>
							<div className='contact-item'>
								...
								<a className='link' href='mailto:hvpnvn@vwu.edu.vn'>
									hvpnvn@vwa.edu.vn
								</a>
							</div>
						</div>
						...
						<div className='address'>
							<div className='address-item'>
								<h3 className='address-title'>Địa chỉ trụ sở:</h3>
								<p>68 Nguyễn Chí Thanh, Đống Đa, Hà Nội</p>
							</div>
						</div>
					</Col>
					...
					<Col span={24} md={8} className='map-wrapper'>
						<iframe
							src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.725570546607!2d105.80357091540292!3d21.044334092520754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab65705879d3%3A0x3cc6c6d9a16a331a!2zNjggTmd1eeG7hW4gQ2jDrSBUaGFuaCwgxJDhu5FuZyDEkGEsIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1655462450302!5m2!1svi!2s'
							width='300'
							height='200'
							style={{ border: 0 }}
							allowFullScreen
